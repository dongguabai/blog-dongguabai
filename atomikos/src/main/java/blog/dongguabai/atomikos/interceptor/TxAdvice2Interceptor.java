package blog.dongguabai.atomikos.interceptor;//package blog.dongguabai.atomikos.interceptor;
//
...
//    private static final String AOP_POINTCUT_EXPRESSION = "execution (* blog.dongguabai.atomikos.service2.*.*(..))";
//
//    @Autowired
